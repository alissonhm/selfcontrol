...
public class MinhaClasseAdapterBanco extends BaseAdapter implements SpinnerAdapter{
	
	public Context context;
	public ArrayList<Banco> itens;
	
	
	public MinhaClasseAdapterBanco(Context context, ArrayList<Banco> itens ) {
