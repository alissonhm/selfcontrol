...
public class MinhaClasseAdapterMovConta extends BaseAdapter implements SpinnerAdapter{
	
	public Context context;
	public ArrayList<MovimentoConta> itens;
	
	
	public MinhaClasseAdapterMovConta(Context context, ArrayList<MovimentoConta> itens ) {
			           ...
			           , ViewGroup parent ) 
	{
		...
		nome.setText("C�digo:" + itens.get(position).getCodigo() + "   " + "Data: " + itens.get(position).getData() + "   " +
					 "Valor: " + itens.get(position).getValor()); 
