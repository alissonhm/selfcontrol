...
public class MinhaClasseAdapterTitRec extends BaseAdapter implements SpinnerAdapter{
	
	public Context context;
	public ArrayList<TituloReceber> itens;
	
	
	public MinhaClasseAdapterTitRec(Context context, ArrayList<TituloReceber> itens ) {
			           ...
			           , ViewGroup parent ) 
	{
		...
		nome.setText("C�digo: " + itens.get(position).getCodigo() + " - " + "Vencimento: " + itens.get(position).getVencimento() + " - " +
