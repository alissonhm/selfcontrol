...
public class MinhaClasseAdapterCheque extends BaseAdapter implements SpinnerAdapter{
	
	public Context context;
	public ArrayList<Cheque> itens;
	
	
	public MinhaClasseAdapterCheque(Context context, ArrayList<Cheque> itens ) {
