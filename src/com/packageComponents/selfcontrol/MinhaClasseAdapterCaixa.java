...
public class MinhaClasseAdapterCaixa extends BaseAdapter implements SpinnerAdapter{
	
	public Context context;
	public ArrayList<Caixa> itens;
	
	
	public MinhaClasseAdapterCaixa(Context context, ArrayList<Caixa> itens ) {
