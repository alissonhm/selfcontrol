...
public class MinhaClasseAdapterMovCaixa extends BaseAdapter implements SpinnerAdapter{
	
	public Context context;
	public ArrayList<MovimentoCaixa> itens;
	
	
	public MinhaClasseAdapterMovCaixa(Context context, ArrayList<MovimentoCaixa> itens ) {
