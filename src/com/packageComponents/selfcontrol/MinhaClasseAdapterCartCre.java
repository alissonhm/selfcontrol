...
public class MinhaClasseAdapterCartCre extends BaseAdapter implements SpinnerAdapter{
	
	public Context context;
	public ArrayList<CartCre> itens;
	
	
	public MinhaClasseAdapterCartCre(Context context, ArrayList<CartCre> itens ) {
