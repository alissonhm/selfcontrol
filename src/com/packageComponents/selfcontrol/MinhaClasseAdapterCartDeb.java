...
public class MinhaClasseAdapterCartDeb extends BaseAdapter implements SpinnerAdapter{
	
	public Context context;
	public ArrayList<CartDeb> itens;
	
	
	public MinhaClasseAdapterCartDeb(Context context, ArrayList<CartDeb> itens ) {
