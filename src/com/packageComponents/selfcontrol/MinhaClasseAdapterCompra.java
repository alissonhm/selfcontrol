...
public class MinhaClasseAdapterCompra extends BaseAdapter implements SpinnerAdapter{
	
	public Context context;
	public ArrayList<Compra> itens;
	
	
	public MinhaClasseAdapterCompra(Context context, ArrayList<Compra> itens ) {
			           ...
			           , ViewGroup parent ) 
	{
		...
		nome.setText("C�digo: " + itens.get(position).getCodigo() + " - " + "Data: " + itens.get(position).getData() + " - " + "Valor: " + itens.get(position).getValor() ); 
